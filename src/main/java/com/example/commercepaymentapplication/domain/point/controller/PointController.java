...
public class PointController {
	...
	@GetMapping
	public ResponseEntity<ApiResponse<GetPointResponse>> getPointBalance(@AuthenticationPrincipal Long userId) {
	...
	public ResponseEntity<ApiResponse<List<GetPointTransactionResponse>>> getPointTransactions(@AuthenticationPrincipal Long userId) {
